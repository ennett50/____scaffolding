...
$(".navbar-toggle").click(function(e){
    ...
    $("body, .sidebar-wrap .sidebar .close").on("click.sidebar", function(){$("body .sidebar-wrap").removeClass("active"); $("body").off("click.sidebar"); $("body .sidebar-wrap").off("click.sidebar");})
    $("body .sidebar-wrap .sidebar").on("click.sidebar", function(e){ e.stopPropagation(); });
    e.stopPropagation();
...
$("#pozvonim-button .pozvonim-button-phone, .callback-link").click(function(e){
    ...
    $("body, #callback-wrap .close").on("click.sidebar", function(){$("body #callback-wrap").removeClass("active"); $("#pozvonim-button").removeClass("hidden"); $("body, #callback-wrap .close").off("click.sidebar"); $("body #callback-wrap").off("click.sidebar"); return false;})
    $("body #callback-wrap .sidebar").on("click.sidebar", function(e){ e.stopPropagation(); });
    e.stopPropagation();
...
$("#catalog-link a").click(function(e){
    if (!$("nav #nav_left").hasClass("active")) {
        ...
        $("body").on("click.catalogMenu", function(){$("nav #nav_left").removeClass("active"); $("#catalog-link a").closest("li").removeClass("active"); $("body").off("click.catalogMenu");})
    }
    else {
